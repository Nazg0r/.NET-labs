...
{
	public class StudentControllerTests(WebApplicationFixture fixture) : IClassFixture<WebApplicationFixture>
	{
		private readonly WebApplicationFixture _fixture = fixture;
		private readonly HttpClient _client = fixture.CreateClient();


		public class Register(WebApplicationFixture fixture) : StudentControllerTests(fixture)
		{
			[Fact]
		...
		public class Login(WebApplicationFixture fixture) : StudentControllerTests(fixture)
		{
			[Fact]
